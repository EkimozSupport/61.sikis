...
Group Music Bot v2 [CLICK HERE](https://github.com/LushaiMusic/VCsMusicBot)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/EkimozSupport/61.sikis)
...
- Some Of The Mandatory Vars Are :-
   ...
   - `STRING_NAME` :  Make a string session from [here](https://replit.com/@ZauteKm/generate-pyrogram-session-string#main.py)
